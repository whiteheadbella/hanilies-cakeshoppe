...
class Command(BaseCommand):
    ...
    def _run_cake_flow(self, driver, wait, By, Select, EC, base_url: str, delay: float):
        ...
        self._fill_text(driver.find_element(
            By.NAME, "delivery_street_address"), "123 Demo Street", delay)
        self._fill_text(driver.find_element(
            By.NAME, "delivery_barangay"), "Gulang-Gulang", delay)
        self._pick(driver.find_element(
            By.NAME, "delivery_city"), "Lucena City (Quezon)", Select, delay)
        self._fill_text(
